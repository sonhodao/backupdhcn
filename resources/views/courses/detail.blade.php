	...
	<div class="container">
		<div class="path magT15">
			...
			<ul class="list flex">
				...
				<li><a href="#">Khóa học Marketing</a> </li>
				<li><a href="#">Lập dự toán công trình dân dụng </a> </li>
			</ul>

		</div>
		<section id="section-8" class="magT15">
			<div class="menu-overlay"></div>
			<div class="popup-style">
				...
				<div class="popup-cont">
					<h3>
						...
						<button class="close-modal">
							<svg width="24" height="24" viewBox="0 0 24 24" role="img"
								aria-label="Close Closes this module.">
					...
					<div class="video">
						<iframe class="player ka-player-iframe centered-when-windowed _1rzb079g" name="ka-player-iframe"
							id="video_9XZypM2Z3Ro" title="Video: Number grid" type="text/html" frameborder="0"
							allowfullscreen=""
							src="https://www.youtube-nocookie.com/embed/9XZypM2Z3Ro/?controls=1&amp;enablejsapi=1&amp;modestbranding=1&amp;showinfo=0&amp;origin=https%3A%2F%2Fwww.khanacademy.org&amp;iv_load_policy=3&amp;html5=1&amp;fs=1&amp;rel=0&amp;hl=en&amp;cc_lang_pref=en&amp;cc_load_policy=1&amp;start=0"
							width="800" height="480" data-youtubeid="9XZypM2Z3Ro" data-translatedyoutubeid="9XZypM2Z3Ro"
							tabindex="0" allow="autoplay" data-translatedyoutubelang="en"></iframe>
					</div>
				</div>
			</div>
			<div class="product-single">
				<div class="content">
					<h2>Lập dự toán công trình dân dụng</h2>
					<div class="s15 cl82 flex magb10 align-i-center">
						<span class="name">Nguyễn Nam</span>
					...
					<p class="descrip">
						Khởi nghiệp là một hành trình thú vị nhưng cũng lắm gian nan. Chính vì sự gian nan đó mà đôi khi
						những người khởi nghiệp chỉ tập trung vào sản phẩm
					</p>
					<div class="bottom-course mobile">
						<div class="price">
							<span class="price-old magr10">1,250,000đ</span><span class="price-reduced">999,000đ
								<span class="no-weight">(-80%)</span></span>
						</div>
						<ul class="list magb20">
							<li>
								<span><img src="image/icon2.png"></span>
								Thời lượng: 18h30p
							</li>
							<li>
								<span><img src="image/icon3.png"></span>
								20 bài giảng
							</li>
							<li>
								<span><img src="image/icon4.png"></span>
					...
					<div class="clearfix">
						...
						<div class="box s15 magb20">
							<p>Ở tội Vi phạm các quy định về quản lý đất đai, VKS đề nghị phạt bị cáo Nguyễn Điểu (cựu
								giám
								đốc Sở Tài nguyên Môi trường Đà Nẵng) 5-6 năm tù, Trần Văn Toán (cựu phó giám đốc Sở Tài
								nguyên Môi trường Đà Nẵng) 4-5 năm tù, Lê Cảnh Dương (cựu phó giám đốc Trung tâm Xúc
								tiến
								Đầu tư Đà Nẵng) 4-5 năm tù, Nguyễn Văn Cán (cựu chánh văn phòng UBND Đà Nẵng) 3-4 năm
								tù,
								Đào Tấn Bằng (cựu phó chánh văn phòng UBND Đà Nẵng) 3-4 năm tù, Nguyễn Viết Vĩnh (cựu
								trưởng
							...
							<p>Nhóm tội Vi phạm quy định về quản lý, sử dụng tài sản nhà nước
								gây thất thoát, bị cáo Nguyễn Thanh Sang (cựu phó giám đốc Sở Tài chính Đà Nẵng) bị đề
								nghị
								...
								giám
								đốc Công ty Công nghệ phẩm Đà Nẵng) 2-3 năm tù, Phan Ngọc Thạch (cựu tổng giám đốc Công
								ty
								Du lịch Đà Nẵng) 2-3 năm tù, Trần Phi (cựu tổng giám đốc Công ty XNK Đà Nẵng) 2-3 năm
								tù, Lê
								Anh Tuấn (nguyên tổng giám đốc Công ty Cung ứng Tàu biển Đà Nẵng) 2-3 năm tù.</p>
						</div>
					</div>
					<div class="clearfix">
						<div class="title-new flex align-i-center justify-c-between">
							Nội dung khóa học
							<span class="s15 no-weight magr30">18h30p</span>
						</div>

						<div class="lesson-card magb20">
							<ul class="list">
					...
					<div class="clearfix">
						...
						<div class="box-review magb20">
							<div class="customer-ratings">
								<span class="ratings-display">5.0</span>
								<div id="half-stars-example">
									<div class="rating-group">
										<label aria-label="0.5 stars" class="rating__label rating__label--half"
											for="rating2-05"><i
					...
					<div class="box-comment">
						<div class="top-comm flex justify-c-between">
							<span class="cl82 s18">Nhận xét</span>
							<div class="titles flex align-i-center">
								<span class="magr10">Sắp xếp:</span>
						...
						<ul class="list magb20">
							<li>
								<div class="user-cus flex">
									<div class="avarta">
										<img
											src="https://pixinvent.com/demo/vuexy-vuejs-admin-dashboard-template/demo-2/img/avatar-s-10.c7eebd6b.jpg">
									</div>
									<div class="clearfix">
										<span class="name">Nguyễn Thu Ngân</span>
										<span class="time">2 tuần trước</span>
									</div>
								</div>
								<div class="content">
									<div id="half-stars-example" class="magb10">
										<div class="rating-group">
											<label aria-label="0.5 stars" class="rating__label rating__label--half"
												for="rating2-05"><i
													class="rating__icon rating__icon--star fa fa-star-half"></i></label>
									...
									<div class="comment">
										Bonjour, sincèrement j ai été très satisfait de la manière très posée à
										présenter le cours, il a de connaissances dans le domaine et est bien informé.
										Merci julien et à bientôt. Pascal de Trêves en Allemagne.
									</div>
								</div>
							</li>
							<li>
								<div class="user-cus flex">
									<div class="avarta">
										<img
											src="https://pixinvent.com/demo/vuexy-vuejs-admin-dashboard-template/demo-2/img/avatar-s-5.99691e54.jpg">
									</div>
									<div class="clearfix">
										<span class="name">Quang Vinh</span>
								...
								<div class="content">
									...
									<div class="comment">
										top ! tres bien fait ! je valide cette formation. fabrice
									</div>
								</div>
							</li>
							<li>
				...
				<div class="course-info">
					<img src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=1050&amp;q=80"
						class="img">
					...
					<div class="tool-btn clearfix">
						<p><button class="btn-add">Thêm vào giỏ hàng</button></p>
						<p><button class="btn-oranges">Đăng ký học</button></p>
					</div>
				</div>
			</div>
			<div class="course">
				<div class="boxcont">
					<div class="title magb20">
						<div class="flex align-i-lg-baseline clearfix">
							<h3 class="s18">Có thể bạn quan tâm</h3>
						</div>
					</div>
					<div class="swiper-container slide-web">
									...
									<div class="col-md-3 col-sm-3">
										<div class="features_list">
											<div class="item-course">
												<div class="img">
													<img
														src="https://images.unsplash.com/photo-1434030216411-0b793f4b4173?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80">

												</div>
												<div class="user">
													<span class="avarta">
														<img
															src="https://images.unsplash.com/flagged/photo-1573740144655-bbb6e88fb18a?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=675&q=80">

													</span>
													<span class="name">Nguyễn Nam</span>
												</div>
												<div class="content">
													<h3><a href="#">Pháp lý kinh doanh - 160+ Vấn đề cần biết
															khi
															khởi
															tạo</a>
													</h3>
														...
														<div id="half-stars-example">
															<div class="rating-group">
																...
																<input class="rating__input" name="rating2"
																	id="rating2-05" value="0.5" type="radio">
																...
																<label aria-label="1.5 stars"
																	...
																	for="rating2-15"><i
																		class="rating__icon rating__icon--star fa fa-star-half"></i></label>
																<input class="rating__input" name="rating2"
																	id="rating2-15" value="1.5" type="radio">
																...
																<label aria-label="3.5 stars"
																	...
																	for="rating2-35"><i
																		class="rating__icon rating__icon--star fa fa-star-half"></i></label>
																<input class="rating__input" name="rating2"
																	id="rating2-35" value="3.5" type="radio">
																...
																<label aria-label="4.5 stars"
																	...
																	for="rating2-45"><i
																		class="rating__icon rating__icon--star fa fa-star-half"></i></label>
																<input class="rating__input" name="rating2"
																	id="rating2-45" value="4.5" type="radio">
													...
													<div class="price">
														<span class="price-old">1,250,000đ</span><span
															class="price-reduced">950,000đ</span>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-md-3 col-sm-3">
										<div class="features_list">
											<div class="item-course">
												<div class="img">
													<img
														src="https://images.unsplash.com/photo-1553484771-11998c592b9c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80">
												...
												<div class="content">
													<h3><a href="#">100 ngày nâng cao trình độ nói tiếng Anh</a>
													</h3>
													<div class="ratting flex align-i-baseline">
														<div id="half-stars-example">
															<div class="rating-group">
							...
							<div>
								<div class="features_list">
									<div class="item-course">
										...
										<div class="content">
											<h3><a href="#">Pháp lý kinh doanh - 160+ Vấn đề cần biết khi
													khởi
													tạo</a>
											</h3>
											<div class="ratting flex align-i-baseline">
