...
// AccountCourseCategoryService

Route::get('registers', 'Course\AccountController@getRegister')->name('register');
Route::post('registers', 'Course\AccountController@postRegister')->name('register');
Route::get('logins', 'Course\AccountController@getLogin')->name('login');
Route::post('logins', 'Course\AccountController@postLogin')->name('login');
Route::get('logouts', 'Course\AccountController@getLogout')->name('course-logout');
Route::get('infos', 'Course\AccountController@getInfo')->name('info');
Route::get('password-changes', 'Course\AccountController@getChanges')->name('password-change');

// Index
Route::get('course-index', 'Course\FrontEnd\IndexController@getIndex')->name('course-index');
Route::get('categories', 'Course\FrontEnd\CourseController@getCategory')->name('category');
Route::get('details', 'Course\FrontEnd\CourseController@getDetail')->name('detail');
Route::get('learnings', 'Course\FrontEnd\CourseController@getLearning')->name('learning');
Route::get('emty-courses', 'Course\FrontEnd\CourseController@getEmtyCourse')->name('emty-course');
Route::get('my-courses', 'Course\FrontEnd\CourseController@getMyCourse')->name('my-course');

Route::prefix('courses')->group(function () {
    Route::resource('course-categories', 'Course\CourseCategoryController')->except('create','edit','show');
    Route::resource('teachers', 'Course\TeacherController')->except('create','show');
    Route::resource('courses', 'Course\CourseController')->except('show');
});